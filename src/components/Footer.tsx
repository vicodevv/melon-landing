    ...
    <footer className="bg-[#212631] text-gray-300 py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            <h3 className="text-white text-xl font-medium mb-4">Private Sector</h3>
            <ul className="space-y-3">
              <li>
                <Link href="https://melon.ng/signin" className="hover:text-white text-[#464D5C] transition-colors">
                  Impact Investors
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-white text-xl font-medium mb-4">Public Sector</h3>
            <ul className="space-y-3">
              <li>
                <Link href="https://melon.ng/signin" className="hover:text-white text-[#464D5C] transition-colors">
                  Government Agencies
          ...
          {/* Application Column - Combined with Socials */}
          <div>
            ...
            {/* Socials section */}
            <h3 className="text-white text-xl font-medium mb-4 mt-8">Socials</h3>
            <div className="flex space-x-4">
              <Link href="https://instagram.com" className="text-[#464D5C] hover:text-white transition-colors">
              ...
              <Link href="https://www.linkedin.com/company/melonsolutions/" className="text-[#464D5C] hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                </svg>
              </Link>
              <Link href="https://facebook.com" className="text-[#464D5C] hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </Link>
              <Link href="https://x.com/melon__ng" className="text-[#464D5C] hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
